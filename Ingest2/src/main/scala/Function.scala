...
object Function {
  ...
  /**
    ...
    */
  def map2[T1, T2, R](t1y: Try[T1], t2y: Try[T2])(f: (T1, T2) => R): Try[R] = Try(f(t1y.get,t2y.get)) // TODO 4
  ...
  /**
    ...
    * @return a value of R, wrapped in Try
    */
  def map3[T1, T2, T3, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3])(f: (T1, T2, T3) => R): Try[R] = Try(f(t1y.get,t2y.get,t3y.get)) // TODO 5

  /**
    * You get the idea...
    */
  def map7[T1, T2, T3, T4, T5, T6, T7, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7])(f: (T1, T2, T3, T4, T5, T6, T7) => R): Try[R] = Try(f(t1y.get,t2y.get,t3y.get,t4y.get,t5y.get,t6y.get,t7y.get)) // TODO 5
  ...
  def lift[T, R](f: T => R): Try[T] => Try[R] = t1y => Try(f(t1y.get))
  ...
  def lift2[T1, T2, R](f: (T1, T2) => R): (Try[T1], Try[T2]) => Try[R] = (t1y, t2y) => Try(f(t1y.get, t2y.get))
  ...
  def lift3[T1, T2, T3, R](f: (T1, T2, T3) => R): (Try[T1], Try[T2], Try[T3]) => Try[R] = (t1y, t2y, t3y) => Try(f(t1y.get, t2y.get, t3y.get))
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = t2 => f(_)(t2)
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R = t3 => t2 => f(_)(t2)(t3)
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = t4 => t3 => t2 => f(_)(t2)(t3)(t4)
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (t1, t2) => f(t1)(t2)
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (t1, t2, t3) => f(t1)(t2)(t3)
}